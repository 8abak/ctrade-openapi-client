...
from datavis.separation import SeparationLiveRuntime, db_connection


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the live separation incremental worker.")
...
def main() -> int:
    ...
    runtime = SeparationLiveRuntime(symbol=str(args.symbol).strip().upper(), batch_size=max(1, int(args.batch_size)))
