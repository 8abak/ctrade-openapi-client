...
from datavis.mavg import MavgLiveRuntime, db_connection


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the live moving-average incremental worker.")
...
def main() -> int:
    ...
    runtime = MavgLiveRuntime(symbol=str(args.symbol).strip().upper(), batch_size=max(1, int(args.batch_size)))
