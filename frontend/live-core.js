...
(function() {
  ...
  async function pollNew() {
    ...
    try {
      const data = await apiLiveWindow({ after_id: lastSeenId + 1, limit: 5000 });
  ...
  async function jumpTo() {
    ...
    const data = await apiLiveWindow({ after_id: id, limit: WINDOW_DEFAULT });
